...
class Games(commands.Cog):
    ...
    async def flip(self, ctx):
        ...
        if coin == 'heads':
            await ctx.send(embed=makeembed('Coin Flip', 'Heads', discord.Color.green(),
                                           'https://www.nicepng.com/png/full/395-3951330_thecoinspot-com-us-washington-head-quarter-dollar-coin.png'))
        else:
            await ctx.send(embed=makeembed('Coin Flip', 'Tails', discord.Color.green(),
    ...
    async def roll(self, ctx):
        ...
        await ctx.send(embed=makeembed('Rolling Dice', f'You rolled a {dice}', discord.Color.green(),
                                       'https://www.nicepng.com/png/full/393-3932479_white-dice-png.png'))
